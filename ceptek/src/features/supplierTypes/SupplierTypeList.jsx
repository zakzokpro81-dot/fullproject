...
import {
  ...
  useSupplierTypeMutations,
} from "./supplierType.hooks";
import { supplierTypeColumns } from "./supplierType.columns";
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box
        ...
        mb={2}
      >
        <Typography variant="h5">{t("supplierTypes.title")}</Typography>
