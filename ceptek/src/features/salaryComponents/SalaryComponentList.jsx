...
import {
  useSalaryComponentQuery,
  useSalaryComponentMutations,
} from "./salaryComponent.hooks";
import { salaryComponentColumns } from "./salaryComponent.columns";
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box
        ...
        mb={2}
      >
        <Typography variant="h5">{t("salaryComponents.title")}</Typography>
        <Box display="flex" gap={1}>
          ...
          <Button variant="contained" onClick={handleOpenAdd}>
            {t("common.addNew")} {t("salaryComponents.entity")}
          </Button>
        </Box>
      </Box>
      <Box mb={2}>
