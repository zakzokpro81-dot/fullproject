...
import { getCategories, getProductTypes, getModels, getAttributes, createProductWithStock, saveProduct,getWarehouses } from "./product.api";
...
const AddProductForm = ({ open, onClose }) => {
    ...
    if (!formReady) return <CircularProgress size={40} style={{ margin: "40px auto", display: "block" }} />;
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
            ...
            <DialogContent>
                ...
                {watchedProductType && attributes?.map(attr => (
                    <Controller
                        key={attr.id}
