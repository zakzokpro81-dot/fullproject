...
export function SupplierList() {
  ...
  } = useSupplierMutations({ onSuccess: handleCloseForm, showMessageDialog });
  const { supplierTypes } = useSupplierFormOptions();
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box
        ...
        mb={2}
      >
        <Typography variant="h5">{t("suppliers:title")}</Typography>
