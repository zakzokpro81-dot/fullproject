...
export interface ApiDeviceVariantDeviceVariant
  extends Struct.CollectionTypeSchema {
  collectionName: 'device_variants';
  info: {
    displayName: 'Device Variant';
    pluralName: 'device-variants';
    singularName: 'device-variant';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    networkType: Schema.Attribute.Enumeration<['g4', 'g5']>;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    region: Schema.Attribute.Enumeration<
      ['Global', 'China', 'India', 'Europe']
    >;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::device-variant.device-variant': ApiDeviceVariantDeviceVariant;
